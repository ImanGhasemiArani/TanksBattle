...
public class MazeGenerator {
    ...
    public void updateGrid() {
        int
                backChar = ConstantData.EMPTY,
                wallChar = ConstantData.BARBED_WIRE,
                containerV = ConstantData.WALL_HORIZONTALLY,
                containerH = ConstantData.WALL_VERTICALLY,
                cellChar = ConstantData.EMPTY,
                pathChar = ConstantData.PATH;
